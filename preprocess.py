...
from visualize_utils import add_white_boarder, crop_image, resize_image#, show_image


def execute(source_img, destination):
    ...
    img = cv2.imread(
        ...
        # "./images/eid.jpg",
        # filename=Path(
        #     "./images/hands-on-machine-learning.jpg",
    ...
    # %%
    # crop image and show
    # img = crop_image(img, ymin=0, ymax=10000, xmin=0, xmax=10000)
    ...
    img_sobel_composit = apply_sobel_filter(
        img, "h") + apply_sobel_filter(img, "v")
